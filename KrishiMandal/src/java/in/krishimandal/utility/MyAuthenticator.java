...
class MyAuthenticator extends Authenticator {
 ...
 class JavaMailUtil {
    ...
    protected static void sendMail(String recipient, String subject, String htmlTextMessage) throws MessagingException {
        MyAuthenticator myAuth = new MyAuthenticator(AppInfo.email, AppInfo.password);
...
//            message.setRecipients(
//                    Message.RecipientType.TO,
//                    InternetAddress.parse("teepavlogsriya@gmail.com")
//            );
//            message.setSubject("From your Lover");
//            message.setText("I love you so much love u love u");
//            //message.setContent(htmlTextMessage, "text/html");
//
//            Transport.send(message);
//
